...
import sistema_de_agencia.ClientePessoaJurdica;
	...
	public TelaCadastroPessoaJuridica() {
		...
		btnSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				ClientePessoaJurdica cp = new ClientePessoaJurdica(txtCep.getText(), txtFCnpj.getText(), txtFDataDeNascimento.getText(), txtFEndereco.getText(), 
						txtFNome.getText(), txtFNumero.getText(), txtFNomeFantasia.getText(), txtFRazaoSocial.getText());
				try 
				{
